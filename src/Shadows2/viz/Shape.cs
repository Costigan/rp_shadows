...
namespace Shadow.viz
{
    public abstract class Shape
    {
        ...
        //todo
        public virtual void DrawInFrustum(bool near, Vector3 eye, float[,] frustum)
        {
        ...
        public virtual void Draw(bool near, Vector3 eye)
        {
            if (!Visible) return;
        ...
        public virtual void Transform(bool near, Vector3 eye)
        {
            Vector3 nearpos = Position - eye;
        ...
        private bool SphereInFrustum(Vector3 pos, float radius, float[,] frustum)
        {
    ...
    public class CubeShape : Shape
    {
        ...
        public override void Transform(bool near, Vector3 eye)
        {
